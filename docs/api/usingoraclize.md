...
* [oraclizeAPI](usingoraclize.md#oraclizeapi)
* [oraclize\_randomDS\_proofVerify](usingoraclize.md#oraclize_randomds_proofverify)
...
* [f\(bytes x\)](usingoraclize.md#f)
* [setProofType\(bytes1 \_proofType\)](usingoraclize.md#setprooftype)
* [setCustomGasPrice\(uint256 \_gasPrice\)](usingoraclize.md#setcustomgasprice)
* [getPrice\(string \_datasource\)](usingoraclize.md#getprice)
* [randomDS\_getSessionPubKeyHash\(\)](usingoraclize.md#randomds_getsessionpubkeyhash)
* [getPrice\(string \_datasource, uint256 \_gasLimit\)](usingoraclize.md#getprice)
* [queryN\(uint256 \_timestamp, string \_datasource, bytes \_argN\)](usingoraclize.md#queryn)
* [query\(uint256 \_timestamp, string \_datasource, string \_arg\)](usingoraclize.md#query)
* [query2\(uint256 \_timestamp, string \_datasource, string \_arg1, string \_arg2\)](usingoraclize.md#query2)
* [query\_withGasLimit\(uint256 \_timestamp, string \_datasource, string \_arg, uint256 \_gasLimit\)](usingoraclize.md#query_withgaslimit)
* [queryN\_withGasLimit\(uint256 \_timestamp, string \_datasource, bytes \_argN, uint256 \_gasLimit\)](usingoraclize.md#queryn_withgaslimit)
* [query2\_withGasLimit\(uint256 \_timestamp, string \_datasource, string \_arg1, string \_arg2, uint256 \_gasLimit\)](usingoraclize.md#query2_withgaslimit)
* [getAddress\(\)](usingoraclize.md#getaddress)
* [init\(struct Buffer.buffer \_buf, uint256 \_capacity\)](usingoraclize.md#init)
* [resize\(struct Buffer.buffer \_buf, uint256 \_capacity\)](usingoraclize.md#resize)
* [max\(uint256 \_a, uint256 \_b\)](usingoraclize.md#max)
* [append\(struct Buffer.buffer \_buf, bytes \_data\)](usingoraclize.md#append)
* [append\(struct Buffer.buffer \_buf, uint8 \_data\)](usingoraclize.md#append)
* [appendInt\(struct Buffer.buffer \_buf, uint256 \_data, uint256 \_len\)](usingoraclize.md#appendint)
* [encodeType\(struct Buffer.buffer \_buf, uint8 \_major, uint256 \_value\)](usingoraclize.md#encodetype)
* [encodeIndefiniteLengthType\(struct Buffer.buffer \_buf, uint8 \_major\)](usingoraclize.md#encodeindefinitelengthtype)
* [encodeUInt\(struct Buffer.buffer \_buf, uint256 \_value\)](usingoraclize.md#encodeuint)
* [encodeInt\(struct Buffer.buffer \_buf, int256 \_value\)](usingoraclize.md#encodeint)
* [encodeBytes\(struct Buffer.buffer \_buf, bytes \_value\)](usingoraclize.md#encodebytes)
* [encodeString\(struct Buffer.buffer \_buf, string \_value\)](usingoraclize.md#encodestring)
* [startArray\(struct Buffer.buffer \_buf\)](usingoraclize.md#startarray)
* [startMap\(struct Buffer.buffer \_buf\)](usingoraclize.md#startmap)
* [endSequence\(struct Buffer.buffer \_buf\)](usingoraclize.md#endsequence)
* [oraclize\_setNetwork\(uint8 \_networkID\)](usingoraclize.md#oraclize_setnetwork)
* [oraclize\_setNetworkName\(string \_network\_name\)](usingoraclize.md#oraclize_setnetworkname)
* [oraclize\_getNetworkName\(\)](usingoraclize.md#oraclize_getnetworkname)
* [oraclize\_setNetwork\(\)](usingoraclize.md#oraclize_setnetwork)
* [\_\_callback\(bytes32 \_myid, string \_result\)](usingoraclize.md#__callback)
* [\_\_callback\(bytes32 \_myid, string \_result, bytes \_proof\)](usingoraclize.md#__callback)
* [oraclize\_getPrice\(string \_datasource\)](usingoraclize.md#oraclize_getprice)
* [oraclize\_getPrice\(string \_datasource, uint256 \_gasLimit\)](usingoraclize.md#oraclize_getprice)
* [oraclize\_query\(string \_datasource, string \_arg\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string \_arg\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string \_arg, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string \_arg, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string \_arg1, string \_arg2\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string \_arg1, string \_arg2\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string \_arg1, string \_arg2, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string \_arg1, string \_arg2, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[\] \_argN\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[\] \_argN\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[\] \_argN, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[\] \_argN, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[1\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[1\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[1\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[1\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[2\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[2\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[2\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[2\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[3\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[3\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[3\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[3\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[4\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[4\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[4\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[4\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[5\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[5\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[5\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[5\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[\] \_argN\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[\] \_argN\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[\] \_argN, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[\] \_argN, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[1\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[1\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[1\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[1\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[2\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[2\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[2\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[2\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[3\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[3\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[3\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[3\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[4\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[4\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[4\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[4\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[5\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[5\] \_args\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[5\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[5\] \_args, uint256 \_gasLimit\)](usingoraclize.md#oraclize_query)
* [oraclize\_setProof\(bytes1 \_proofP\)](usingoraclize.md#oraclize_setproof)
* [oraclize\_cbAddress\(\)](usingoraclize.md#oraclize_cbaddress)
* [getCodeSize\(address \_addr\)](usingoraclize.md#getcodesize)
* [oraclize\_setCustomGasPrice\(uint256 \_gasPrice\)](usingoraclize.md#oraclize_setcustomgasprice)
* [oraclize\_randomDS\_getSessionPubKeyHash\(\)](usingoraclize.md#oraclize_randomds_getsessionpubkeyhash)
* [parseAddr\(string \_a\)](usingoraclize.md#parseaddr)
* [strCompare\(string \_a, string \_b\)](usingoraclize.md#strcompare)
* [indexOf\(string \_haystack, string \_needle\)](usingoraclize.md#indexof)
* [strConcat\(string \_a, string \_b\)](usingoraclize.md#strconcat)
* [strConcat\(string \_a, string \_b, string \_c\)](usingoraclize.md#strconcat)
* [strConcat\(string \_a, string \_b, string \_c, string \_d\)](usingoraclize.md#strconcat)
* [strConcat\(string \_a, string \_b, string \_c, string \_d, string \_e\)](usingoraclize.md#strconcat)
* [safeParseInt\(string \_a\)](usingoraclize.md#safeparseint)
* [safeParseInt\(string \_a, uint256 \_b\)](usingoraclize.md#safeparseint)
* [parseInt\(string \_a\)](usingoraclize.md#parseint)
* [parseInt\(string \_a, uint256 \_b\)](usingoraclize.md#parseint)
* [uint2str\(uint256 \_i\)](usingoraclize.md#uint2str)
* [stra2cbor\(string\[\] \_arr\)](usingoraclize.md#stra2cbor)
* [ba2cbor\(bytes\[\] \_arr\)](usingoraclize.md#ba2cbor)
* [oraclize\_newRandomDSQuery\(uint256 \_delay, uint256 \_nbytes, uint256 \_customGasLimit\)](usingoraclize.md#oraclize_newrandomdsquery)
* [oraclize\_randomDS\_setCommitment\(bytes32 \_queryId, bytes32 \_commitment\)](usingoraclize.md#oraclize_randomds_setcommitment)
* [verifySig\(bytes32 \_tosignh, bytes \_dersig, bytes \_pubkey\)](usingoraclize.md#verifysig)
* [oraclize\_randomDS\_proofVerify\_\_sessionKeyValidity\(bytes \_proof, uint256 \_sig2offset\)](usingoraclize.md#oraclize_randomds_proofverify__sessionkeyvalidity)
* [oraclize\_randomDS\_proofVerify\_\_returnCode\(bytes32 \_queryId, string \_result, bytes \_proof\)](usingoraclize.md#oraclize_randomds_proofverify__returncode)
* [matchBytes32Prefix\(bytes32 \_content, bytes \_prefix, uint256 \_nRandomBytes\)](usingoraclize.md#matchbytes32prefix)
* [oraclize\_randomDS\_proofVerify\_\_main\(bytes \_proof, bytes32 \_queryId, bytes \_result, string \_contextName\)](usingoraclize.md#oraclize_randomds_proofverify__main)
* [copyBytes\(bytes \_from, uint256 \_fromOffset, uint256 \_length, bytes \_to, uint256 \_toOffset\)](usingoraclize.md#copybytes)
* [safer\_ecrecover\(bytes32 \_hash, uint8 \_v, bytes32 \_r, bytes32 \_s\)](usingoraclize.md#safer_ecrecover)
* [ecrecovery\(bytes32 \_hash, bytes \_sig\)](usingoraclize.md#ecrecovery)
* [safeMemoryCleaner\(\)](usingoraclize.md#safememorycleaner)
