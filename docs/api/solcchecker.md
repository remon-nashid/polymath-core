...
* [oraclizeAPI](solcchecker.md#oraclizeapi)
* [oraclize\_randomDS\_proofVerify](solcchecker.md#oraclize_randomds_proofverify)
...
* [f\(bytes x\)](solcchecker.md#f)
* [setProofType\(bytes1 \_proofType\)](solcchecker.md#setprooftype)
* [setCustomGasPrice\(uint256 \_gasPrice\)](solcchecker.md#setcustomgasprice)
* [getPrice\(string \_datasource\)](solcchecker.md#getprice)
* [randomDS\_getSessionPubKeyHash\(\)](solcchecker.md#randomds_getsessionpubkeyhash)
* [getPrice\(string \_datasource, uint256 \_gasLimit\)](solcchecker.md#getprice)
* [queryN\(uint256 \_timestamp, string \_datasource, bytes \_argN\)](solcchecker.md#queryn)
* [query\(uint256 \_timestamp, string \_datasource, string \_arg\)](solcchecker.md#query)
* [query2\(uint256 \_timestamp, string \_datasource, string \_arg1, string \_arg2\)](solcchecker.md#query2)
* [query\_withGasLimit\(uint256 \_timestamp, string \_datasource, string \_arg, uint256 \_gasLimit\)](solcchecker.md#query_withgaslimit)
* [queryN\_withGasLimit\(uint256 \_timestamp, string \_datasource, bytes \_argN, uint256 \_gasLimit\)](solcchecker.md#queryn_withgaslimit)
* [query2\_withGasLimit\(uint256 \_timestamp, string \_datasource, string \_arg1, string \_arg2, uint256 \_gasLimit\)](solcchecker.md#query2_withgaslimit)
* [getAddress\(\)](solcchecker.md#getaddress)
* [init\(struct Buffer.buffer \_buf, uint256 \_capacity\)](solcchecker.md#init)
* [resize\(struct Buffer.buffer \_buf, uint256 \_capacity\)](solcchecker.md#resize)
* [max\(uint256 \_a, uint256 \_b\)](solcchecker.md#max)
* [append\(struct Buffer.buffer \_buf, bytes \_data\)](solcchecker.md#append)
* [append\(struct Buffer.buffer \_buf, uint8 \_data\)](solcchecker.md#append)
* [appendInt\(struct Buffer.buffer \_buf, uint256 \_data, uint256 \_len\)](solcchecker.md#appendint)
* [encodeType\(struct Buffer.buffer \_buf, uint8 \_major, uint256 \_value\)](solcchecker.md#encodetype)
* [encodeIndefiniteLengthType\(struct Buffer.buffer \_buf, uint8 \_major\)](solcchecker.md#encodeindefinitelengthtype)
* [encodeUInt\(struct Buffer.buffer \_buf, uint256 \_value\)](solcchecker.md#encodeuint)
* [encodeInt\(struct Buffer.buffer \_buf, int256 \_value\)](solcchecker.md#encodeint)
* [encodeBytes\(struct Buffer.buffer \_buf, bytes \_value\)](solcchecker.md#encodebytes)
* [encodeString\(struct Buffer.buffer \_buf, string \_value\)](solcchecker.md#encodestring)
* [startArray\(struct Buffer.buffer \_buf\)](solcchecker.md#startarray)
* [startMap\(struct Buffer.buffer \_buf\)](solcchecker.md#startmap)
* [endSequence\(struct Buffer.buffer \_buf\)](solcchecker.md#endsequence)
* [oraclize\_setNetwork\(uint8 \_networkID\)](solcchecker.md#oraclize_setnetwork)
* [oraclize\_setNetworkName\(string \_network\_name\)](solcchecker.md#oraclize_setnetworkname)
* [oraclize\_getNetworkName\(\)](solcchecker.md#oraclize_getnetworkname)
* [oraclize\_setNetwork\(\)](solcchecker.md#oraclize_setnetwork)
* [\_\_callback\(bytes32 \_myid, string \_result\)](solcchecker.md#__callback)
* [\_\_callback\(bytes32 \_myid, string \_result, bytes \_proof\)](solcchecker.md#__callback)
* [oraclize\_getPrice\(string \_datasource\)](solcchecker.md#oraclize_getprice)
* [oraclize\_getPrice\(string \_datasource, uint256 \_gasLimit\)](solcchecker.md#oraclize_getprice)
* [oraclize\_query\(string \_datasource, string \_arg\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string \_arg\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string \_arg, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string \_arg, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string \_arg1, string \_arg2\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string \_arg1, string \_arg2\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string \_arg1, string \_arg2, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string \_arg1, string \_arg2, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[\] \_argN\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[\] \_argN\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[\] \_argN, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[\] \_argN, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[1\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[1\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[1\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[1\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[2\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[2\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[2\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[2\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[3\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[3\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[3\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[3\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[4\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[4\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[4\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[4\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[5\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[5\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, string\[5\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, string\[5\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[\] \_argN\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[\] \_argN\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[\] \_argN, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[\] \_argN, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[1\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[1\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[1\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[1\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[2\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[2\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[2\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[2\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[3\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[3\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[3\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[3\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[4\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[4\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[4\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[4\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[5\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[5\] \_args\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(uint256 \_timestamp, string \_datasource, bytes\[5\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_query\(string \_datasource, bytes\[5\] \_args, uint256 \_gasLimit\)](solcchecker.md#oraclize_query)
* [oraclize\_setProof\(bytes1 \_proofP\)](solcchecker.md#oraclize_setproof)
* [oraclize\_cbAddress\(\)](solcchecker.md#oraclize_cbaddress)
* [getCodeSize\(address \_addr\)](solcchecker.md#getcodesize)
* [oraclize\_setCustomGasPrice\(uint256 \_gasPrice\)](solcchecker.md#oraclize_setcustomgasprice)
* [oraclize\_randomDS\_getSessionPubKeyHash\(\)](solcchecker.md#oraclize_randomds_getsessionpubkeyhash)
* [parseAddr\(string \_a\)](solcchecker.md#parseaddr)
* [strCompare\(string \_a, string \_b\)](solcchecker.md#strcompare)
* [indexOf\(string \_haystack, string \_needle\)](solcchecker.md#indexof)
* [strConcat\(string \_a, string \_b\)](solcchecker.md#strconcat)
* [strConcat\(string \_a, string \_b, string \_c\)](solcchecker.md#strconcat)
* [strConcat\(string \_a, string \_b, string \_c, string \_d\)](solcchecker.md#strconcat)
* [strConcat\(string \_a, string \_b, string \_c, string \_d, string \_e\)](solcchecker.md#strconcat)
* [safeParseInt\(string \_a\)](solcchecker.md#safeparseint)
* [safeParseInt\(string \_a, uint256 \_b\)](solcchecker.md#safeparseint)
* [parseInt\(string \_a\)](solcchecker.md#parseint)
* [parseInt\(string \_a, uint256 \_b\)](solcchecker.md#parseint)
* [uint2str\(uint256 \_i\)](solcchecker.md#uint2str)
* [stra2cbor\(string\[\] \_arr\)](solcchecker.md#stra2cbor)
* [ba2cbor\(bytes\[\] \_arr\)](solcchecker.md#ba2cbor)
* [oraclize\_newRandomDSQuery\(uint256 \_delay, uint256 \_nbytes, uint256 \_customGasLimit\)](solcchecker.md#oraclize_newrandomdsquery)
* [oraclize\_randomDS\_setCommitment\(bytes32 \_queryId, bytes32 \_commitment\)](solcchecker.md#oraclize_randomds_setcommitment)
* [verifySig\(bytes32 \_tosignh, bytes \_dersig, bytes \_pubkey\)](solcchecker.md#verifysig)
* [oraclize\_randomDS\_proofVerify\_\_sessionKeyValidity\(bytes \_proof, uint256 \_sig2offset\)](solcchecker.md#oraclize_randomds_proofverify__sessionkeyvalidity)
* [oraclize\_randomDS\_proofVerify\_\_returnCode\(bytes32 \_queryId, string \_result, bytes \_proof\)](solcchecker.md#oraclize_randomds_proofverify__returncode)
* [matchBytes32Prefix\(bytes32 \_content, bytes \_prefix, uint256 \_nRandomBytes\)](solcchecker.md#matchbytes32prefix)
* [oraclize\_randomDS\_proofVerify\_\_main\(bytes \_proof, bytes32 \_queryId, bytes \_result, string \_contextName\)](solcchecker.md#oraclize_randomds_proofverify__main)
* [copyBytes\(bytes \_from, uint256 \_fromOffset, uint256 \_length, bytes \_to, uint256 \_toOffset\)](solcchecker.md#copybytes)
* [safer\_ecrecover\(bytes32 \_hash, uint8 \_v, bytes32 \_r, bytes32 \_s\)](solcchecker.md#safer_ecrecover)
* [ecrecovery\(bytes32 \_hash, bytes \_sig\)](solcchecker.md#ecrecovery)
* [safeMemoryCleaner\(\)](solcchecker.md#safememorycleaner)
